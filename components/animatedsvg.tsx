...
const AnimatedSVG = () => {
    ...
    // useEffectを使わず、SVG描画時にCSSアニメーションで制御
        ...
        >
            <style>{`
                .animated-path {
                    ...
                    animation: draw-path 1.2s cubic-bezier(.77,0,.18,1) forwards;
                }
                @keyframes draw-path {
                    to {
                        stroke-dashoffset: 0;
            ...
            <g>
                <path
                    ...
                    d="M29.77,15.04l-5.19,8.36c-1.02,1.65,1.57,3.15,2.59,1.51l5.19-8.36c1.02-1.65-1.57-3.15-2.59-1.51h0Z"
                />
                <path
                    className="animated-path"
